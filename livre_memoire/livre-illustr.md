...
> **[ILLUSTRATION : IMAGE 1]** ❌non prise ❌
> *Description : Évolution visuelle des outils de diagnostic : du dermatoscope manuel vers l'analyse par smartphone.*
...
> **[ILLUSTRATION : DIAGRAMME MERMAID]** ❌ non prise ❌
> ```mermaid
> sequenceDiagram
>     Patient->>Smartphone: Capture image (Anonyme)
>     Smartphone->>Smartphone: Chiffrement Local
>     Smartphone->>Cloud: Envoi via HTTPS (Tunnel sécurisé)
>     Cloud->>Base de données: Stockage chiffré
> ```
