...
#### 3.2.2 Transparence algorithmique et Explainable AI (XAI) comme exigence éthique
...
### 5.3 Interprétabilité et Fiabilité du modèle (Explainable AI - XAI)
#### 5.3.1 Visualisation des zones d'activation via Grad-CAM (Heatmaps)
#### 5.3.2 Analyse des faux positifs et gestion de l'incertitude médicale
